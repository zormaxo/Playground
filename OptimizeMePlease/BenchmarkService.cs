...
namespace OptimizeMePlease
{
    ...
    public class BenchmarkService
    {
        ...
        public List<AuthorDTO> GetAuthors_Optimized()
        {
            ...
            var authors = dbContext
                .Authors.Include(x => x.Books.Where(b => b.Published.Year < 1900))
        ...
        public List<AuthorDTO_OptimizedStruct> GetAuthors_Optimized_Struct()
        {
            ...
            return dbContext
                ...
                .Select(x => new AuthorDTO_OptimizedStruct
                {
                    ...
                    UserName = x.User.UserName,
                    Books = x
                        .Books.Where(b => b.Published.Year < 1900)
                        .Select(y => new BookDTO_OptimizedStruct
                        {
                            Title = y.Name,
        ...
        public List<AuthorDTO_OptimizedStruct> GetAuthors_Optimized_Struct1()
        {
            ...
            return dbContext
                .Authors.Where(x =>
                    x.Country == "Serbia"
                    && x.Age == 27
                    && x.Books.Any(y => y.Published.Year < 1900)
                )
