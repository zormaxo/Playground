...
namespace OptimizeMePlease
{
    ...
    public class Program
    {
        ...
        {
            string sqlConnectionString = @"Server=localhost;Database=OptimizeMePlease;User Id=sa;Password=Aa123456!;MultipleActiveResultSets=true;TrustServerCertificate=True";
