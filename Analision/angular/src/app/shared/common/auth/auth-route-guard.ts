...
export class AppRouteGuard implements CanActivate, CanActivateChild, CanLoad {
    private _permissionChecker = inject(PermissionCheckerService);
    private _router = inject(Router);
    private _sessionService = inject(AppSessionService);
    private _refreshTokenService = inject(RefreshTokenService);
