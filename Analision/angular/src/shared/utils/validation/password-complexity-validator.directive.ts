...
export class PasswordComplexityValidator implements Validator {
    readonly requireDigit = input<boolean>(undefined);
    readonly requireUppercase = input<boolean>(undefined);
    readonly requireLowercase = input<boolean>(undefined);
    readonly requireNonAlphanumeric = input<boolean>(undefined);
    readonly requiredLength = input<number>(undefined);
