...
namespace Analision.Core.Base;

public abstract class AnalisionQueryBase<TField, TResult> : ITransientDependency
{
    ...
    protected AnalisionQueryBase(string fieldName,
