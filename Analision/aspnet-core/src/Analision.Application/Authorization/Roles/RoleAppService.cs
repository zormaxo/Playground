...
using Analision.Authorization.Permissions;
using Analision.Authorization.Permissions.Dto;
using Analision.Authorization.Roles.Dto;

namespace Analision.Authorization.Roles;

/// <summary>
/// Application service that is used by 'role management' page.
/// </summary>
[AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
public class RoleAppService : AnalisionAppServiceBase, IRoleAppService
{
