...
using Analision.Authorization.Users.Delegation.Dto;

namespace Analision.Authorization.Users.Delegation;

[AbpAuthorize]
public class UserDelegationAppService : AnalisionAppServiceBase, IUserDelegationAppService
{
