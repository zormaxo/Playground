...
public class SessionAppService : AnalisionAppServiceBase, ISessionAppService
{
        ...
        return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = AnalisionConsts.Currency,
                    CurrencySign = AnalisionConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = AnalisionConsts.AllowTenantsToChangeEmailSettings,
