...
using Analision.DynamicEntityPropertyValues.Dto;

namespace Analision.DynamicEntityProperties;

[AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
public class DynamicEntityPropertyValueAppService : AnalisionAppServiceBase, IDynamicEntityPropertyValueAppService
{
