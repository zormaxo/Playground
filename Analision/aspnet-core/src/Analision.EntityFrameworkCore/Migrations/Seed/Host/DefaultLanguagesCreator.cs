...
namespace Analision.Migrations.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly AnalisionDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = AnalisionConsts.MultiTenancyEnabled ? null : (int?)1;
    ...
    public DefaultLanguagesCreator(AnalisionDbContext context)
    {
        _context = context;
    }
