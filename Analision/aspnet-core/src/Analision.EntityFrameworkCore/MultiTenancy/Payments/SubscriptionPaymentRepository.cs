...
public class SubscriptionPaymentRepository : AnalisionRepositoryBase<SubscriptionPayment, long>,
    ISubscriptionPaymentRepository
{
    public SubscriptionPaymentRepository(IDbContextProvider<AnalisionDbContext> dbContextProvider)
