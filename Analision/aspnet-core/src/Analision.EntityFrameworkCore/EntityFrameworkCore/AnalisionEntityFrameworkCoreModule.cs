...
public class AnalisionEntityFrameworkCoreModule : AbpModule
{
    ...
    public override void PreInitialize()
    {
        ...
        {
            Configuration.Modules.AbpEfCore().AddDbContext<AnalisionDbContext>(options =>
            {
                if (options.ExistingConnection != null)
                {
                    AnalisionDbContextConfigurer.Configure(options.DbContextOptions,
        ...
        //Configuration.EntityHistory.Selectors.Add("AnalisionEntities", EntityHistoryHelper.TrackedTypes);
        //Configuration.CustomConfigProviders.Add(new EntityHistoryConfigProvider(Configuration));
    }

    public override void Initialize()
    {
        IocManager.RegisterAssemblyByConvention(typeof(AnalisionEntityFrameworkCoreModule).GetAssembly());
    }
