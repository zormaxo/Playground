...
namespace Analision.Authentication.TwoFactor.Google;

public class GoogleAuthenticatorProvider : AnalisionServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
{
    ...
    public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
    {
        ...
        var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Analision", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
