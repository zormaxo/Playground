...
using Analision.DashboardCustomization;
...
public class AppSettingProvider : SettingProvider
{
    ...
    {
        if (!AnalisionConsts.AllowTenantsToChangeEmailSettings)
        {
        ...
        return new[]
        {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        AnalisionConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant),
    ...
    private IEnumerable<SettingDefinition> GetDashboardSettings()
    {
        ...
        return new[]
        {
                new SettingDefinition(
                    GetSettingName(
                        AnalisionDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        AnalisionDashboardCustomizationConsts.Applications.Angular,
    ...
    public Dashboard GetDefaultMvcHostDashboardView()
    {
        ...
        {
            DashboardName = AnalisionDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
            Pages = new List<Page>
                {
                    new Page($"Page_{AnalisionDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{AnalisionDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = AnalisionDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = AnalisionDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    AnalisionDashboardCustomizationConsts.Widgets.Host
    ...
    public Dashboard GetDefaultMvcTenantDashboardView()
    {
        ...
        return new Dashboard
        {
            DashboardName = AnalisionDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
            Pages = new List<Page>
                {
                    new Page($"Page_{AnalisionDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{AnalisionDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = AnalisionDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = AnalisionDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    AnalisionDashboardCustomizationConsts.Widgets.Tenant
    ...
    {
        return new LocalizableString(name, AnalisionConsts.LocalizationSourceName);
    }
}
