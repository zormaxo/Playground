...
/// </summary>
public class AnalisionSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public AnalisionSimplePermissionDependency()
    {
    ...
    public AnalisionSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public AnalisionSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
