...
public class StripeGatewayManager : AnalisionServiceBase,
    ...
    ITransientDependency
{
    ...
    public async Task<StripeIdResponse> GetOrCreatePlanForPayment(long paymentId)
    {
        ...
        var product = await GetOrCreateProductAsync(AnalisionConsts.ProductName);
