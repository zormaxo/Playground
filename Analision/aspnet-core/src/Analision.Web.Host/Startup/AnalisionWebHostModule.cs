...
using Analision.Authorization.Users.Password;
...
using Analision.Web.Startup.ExternalLoginInfoProviders;
...
public class AnalisionWebHostModule : AbpModule
{
    private readonly IWebHostEnvironment _env;
    private readonly IConfigurationRoot _appConfiguration;

    public AnalisionWebHostModule(
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(AnalisionWebHostModule).GetAssembly());
    }
