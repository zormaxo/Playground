...
namespace Analision.Web.Public.Startup;

[DependsOn(
    typeof(AnalisionWebCoreModule)
)]
public class AnalisionWebFrontEndModule : AbpModule
{
    private readonly IConfigurationRoot _appConfiguration;

    public AnalisionWebFrontEndModule(IWebHostEnvironment env, AnalisionEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
    {
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(AnalisionWebFrontEndModule).GetAssembly());
    }
}
