...
/// </summary>
public static class AnalisionJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, AnalisionAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
