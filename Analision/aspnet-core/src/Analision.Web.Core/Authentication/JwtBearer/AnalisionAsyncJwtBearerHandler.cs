...
public class AnalisionAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
{
    ...
    /// </summary>
    /// <inheritdoc />
    public AnalisionAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
